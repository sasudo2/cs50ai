...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        # Separate neighbors into known and unknown
        for neighbor in neighbors:
            if neighbor in self.mines:
                count -= 1  # Reduce count for known mines
            elif neighbor not in self.safes:
                unknown_blocks.add(neighbor)  # Only add truly unknown cells
        
        # Add new sentence
        if unknown_blocks:
            new_sentence = Sentence(unknown_blocks, count)
        ...
        while True:
            ...
            for sentence1 in self.knowledge:
                for sentence2 in self.knowledge:
                    if sentence1 != sentence2 and sentence2.cells.issubset(sentence1.cells):
                        ...
                        if new_cells:  # Only if there are cells in the difference
            ...
            if not mines_found and not safes_found:
                break
